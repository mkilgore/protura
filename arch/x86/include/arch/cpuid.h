 ...
 */
#ifndef INCLUDE_ARCH_CPUID_H
#define INCLUDE_ARCH_CPUID_H
...
extern const char *cpuid_vendor_ids[CPUID_VENDOR_LAST];
extern uint32_t cpuid_ecx, cpuid_edx;
extern char cpuid_id[10];
