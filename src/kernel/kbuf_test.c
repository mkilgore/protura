...
static const struct ktest_unit kbuf_test_units[] = {
    ...
    KTEST_UNIT("kbuf-write-one-page-test", kbuf_write_one_page_test, KT_INT(0)),
    KTEST_UNIT("kbuf-write-one-page-test", kbuf_write_one_page_test, KT_INT(1)),
    KTEST_UNIT("kbuf-write-one-page-test", kbuf_write_one_page_test, KT_INT(256)),
    KTEST_UNIT("kbuf-write-one-page-test", kbuf_write_one_page_test, KT_INT(PG_SIZE)),
    KTEST_UNIT("kbuf-write-two-page-test", kbuf_write_two_page_test, KT_INT(0)),
    KTEST_UNIT("kbuf-write-two-page-test", kbuf_write_two_page_test, KT_INT(1)),
    KTEST_UNIT("kbuf-write-two-page-test", kbuf_write_two_page_test, KT_INT(256)),
    KTEST_UNIT("kbuf-write-two-page-test", kbuf_write_two_page_test, KT_INT(PG_SIZE)),
    KTEST_UNIT("kbuf-multi-write-test", kbuf_multiwrite_test, KT_INT(32)),
    KTEST_UNIT("kbuf-multi-write-test", kbuf_multiwrite_test, KT_INT(64)),
    KTEST_UNIT("kbuf-multi-write-test", kbuf_multiwrite_test, KT_INT(256)),
    KTEST_UNIT("kbuf-multi-write-test", kbuf_multiwrite_test, KT_INT(PG_SIZE)),
    KTEST_UNIT("kbuf-multi-write-test", kbuf_multiwrite_test, KT_INT(PG_SIZE * 2)),
    KTEST_UNIT("kbuf-multi-write-test", kbuf_multiwrite_test, KT_INT(PG_SIZE * 4)),
    KTEST_UNIT("kbuf-multi-write-test", kbuf_multiwrite_test, KT_INT(10)),
    KTEST_UNIT("kbuf-multi-write-test", kbuf_multiwrite_test, KT_INT(100)),
    KTEST_UNIT("kbuf-multi-write-test", kbuf_multiwrite_test, KT_INT(1000)),
    KTEST_UNIT("kbuf-multi-write-test", kbuf_multiwrite_test, KT_INT(10000)),
    KTEST_UNIT("kbuf-read-from-start-test", kbuf_read_from_start_test, KT_INT(0)),
    KTEST_UNIT("kbuf-read-from-start-test", kbuf_read_from_start_test, KT_INT(1)),
    KTEST_UNIT("kbuf-read-from-start-test", kbuf_read_from_start_test, KT_INT(20)),
    KTEST_UNIT("kbuf-read-from-start-test", kbuf_read_from_start_test, KT_INT(256)),
    KTEST_UNIT("kbuf-read-from-start-test", kbuf_read_from_start_test, KT_INT(2048)),
    KTEST_UNIT("kbuf-read-from-start-test", kbuf_read_from_start_test, KT_INT(3000)),
    KTEST_UNIT("kbuf-read-from-start-test", kbuf_read_from_start_test, KT_INT(PG_SIZE)),
    KTEST_UNIT("kbuf-read-past-the-end-test", kbuf_read_past_the_end_test, KT_INT(0)),
    KTEST_UNIT("kbuf-read-past-the-end-test", kbuf_read_past_the_end_test, KT_INT(1)),
    KTEST_UNIT("kbuf-read-past-the-end-test", kbuf_read_past_the_end_test, KT_INT(20)),
    KTEST_UNIT("kbuf-read-past-the-end-test", kbuf_read_past_the_end_test, KT_INT(256)),
    KTEST_UNIT("kbuf-read-past-the-end-test", kbuf_read_past_the_end_test, KT_INT(2048)),
    KTEST_UNIT("kbuf-read-past-the-end-test", kbuf_read_past_the_end_test, KT_INT(3000)),
    KTEST_UNIT("kbuf-read-past-the-end-test", kbuf_read_past_the_end_test, KT_INT(PG_SIZE - 1)),
    KTEST_UNIT("kbuf-read-from-offset-test", kbuf_read_from_offset_test, KT_INT(1)),
    KTEST_UNIT("kbuf-read-from-offset-test", kbuf_read_from_offset_test, KT_INT(20)),
    KTEST_UNIT("kbuf-read-from-offset-test", kbuf_read_from_offset_test, KT_INT(256)),
    KTEST_UNIT("kbuf-read-from-offset-test", kbuf_read_from_offset_test, KT_INT(2048)),
    KTEST_UNIT("kbuf-read-from-offset-test", kbuf_read_from_offset_test, KT_INT(3000)),
    KTEST_UNIT("kbuf-read-from-offset-test", kbuf_read_from_offset_test, KT_INT(PG_SIZE - 1)),
    KTEST_UNIT("kbuf-multi-read-test", kbuf_multiread_test, KT_INT(32)),
    KTEST_UNIT("kbuf-multi-read-test", kbuf_multiread_test, KT_INT(64)),
    KTEST_UNIT("kbuf-multi-read-test", kbuf_multiread_test, KT_INT(256)),
    KTEST_UNIT("kbuf-multi-read-test", kbuf_multiread_test, KT_INT(PG_SIZE)),
    KTEST_UNIT("kbuf-multi-read-test", kbuf_multiread_test, KT_INT(PG_SIZE * 2)),
    KTEST_UNIT("kbuf-multi-read-test", kbuf_multiread_test, KT_INT(PG_SIZE * 4)),
    KTEST_UNIT("kbuf-multi-read-test", kbuf_multiread_test, KT_INT(10)),
    KTEST_UNIT("kbuf-multi-read-test", kbuf_multiread_test, KT_INT(100)),
    KTEST_UNIT("kbuf-multi-read-test", kbuf_multiread_test, KT_INT(1000)),
    KTEST_UNIT("kbuf-multi-read-test", kbuf_multiread_test, KT_INT(10000)),
