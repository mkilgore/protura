...
static const struct ktest_unit syscall_test_units[] = {
    KTEST_UNIT("syscall-open-test", syscall_open_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-read-test", syscall_read_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-write-test", syscall_write_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-read-dent-test", syscall_read_dent_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-truncate-test", syscall_truncate_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-link-test", syscall_link_test,
            (KT_KERNEL_BUF(""), KT_USER_BUF(NULL)),
            (KT_KERNEL_BUF(""), KT_USER_BUF(0xBFFFFFF0)),
            (KT_KERNEL_BUF(""), KT_USER_BUF(0xC0200000)),
            (KT_USER_BUF(NULL), KT_KERNEL_BUF("")),
            (KT_USER_BUF(0xBFFFFFF0), KT_KERNEL_BUF("")),
            (KT_USER_BUF(0xC0200000), KT_KERNEL_BUF(""))),

    KTEST_UNIT("syscall-unlink-test", syscall_unlink_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-stat-test", syscall_stat_test,
            (KT_KERNEL_BUF(""), KT_USER_BUF(NULL)),
            (KT_KERNEL_BUF(""), KT_USER_BUF(0xBFFFFFF0)),
            (KT_KERNEL_BUF(""), KT_USER_BUF(0xC0200000)),
            (KT_USER_BUF(NULL), KT_KERNEL_BUF("")),
    ...
    KTEST_UNIT("syscall-fstat-test", syscall_fstat_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-mkdir-test", syscall_mkdir_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-mknod-test", syscall_mknod_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-rmdir-test", syscall_rmdir_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-rename-test", syscall_rename_test,
            (KT_KERNEL_BUF(""), KT_USER_BUF(NULL)),
            (KT_KERNEL_BUF(""), KT_USER_BUF(0xBFFFFFF0)),
            (KT_KERNEL_BUF(""), KT_USER_BUF(0xC0200000)),
            (KT_USER_BUF(NULL), KT_KERNEL_BUF("")),
    ...
    KTEST_UNIT("syscall-lstat-test", syscall_lstat_test,
            (KT_KERNEL_BUF(""), KT_USER_BUF(NULL)),
            (KT_KERNEL_BUF(""), KT_USER_BUF(0xBFFFFFF0)),
            (KT_KERNEL_BUF(""), KT_USER_BUF(0xC0200000)),
            (KT_USER_BUF(NULL), KT_KERNEL_BUF("")),
    ...
    KTEST_UNIT("syscall-readlink-test", syscall_readlink_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-symlink-test", syscall_symlink_test,
            (KT_KERNEL_BUF(""), KT_USER_BUF(NULL)),
            (KT_KERNEL_BUF(""), KT_USER_BUF(0xBFFFFFF0)),
            (KT_KERNEL_BUF(""), KT_USER_BUF(0xC0200000)),
            (KT_USER_BUF(NULL), KT_KERNEL_BUF("")),
    ...
    KTEST_UNIT("syscall-mount-test", syscall_mount_test,
            (KT_KERNEL_BUF("/dev/hda1"), KT_USER_BUF(NULL),       KT_KERNEL_BUF("")),
            (KT_KERNEL_BUF("/dev/hda1"), KT_USER_BUF(0xBFFFFFF0), KT_KERNEL_BUF("")),
            (KT_KERNEL_BUF("/dev/hda1"), KT_USER_BUF(0xC0200000), KT_KERNEL_BUF("")),
            (KT_USER_BUF(0xBFFFFFF0),    KT_KERNEL_BUF(""),       KT_KERNEL_BUF("")),
            (KT_USER_BUF(0xC0200000),    KT_KERNEL_BUF(""),       KT_KERNEL_BUF("")),
            (KT_KERNEL_BUF("/dev/hda1"), KT_KERNEL_BUF(""),       KT_USER_BUF(NULL)),
            (KT_KERNEL_BUF("/dev/hda1"), KT_KERNEL_BUF(""),       KT_USER_BUF(0xBFFFFFF0)),
            (KT_KERNEL_BUF("/dev/hda1"), KT_KERNEL_BUF(""),       KT_USER_BUF(0xC0200000))),
    ...
    KTEST_UNIT("syscall-umount-test", syscall_umount_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-chdir-test", syscall_chdir_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFF0)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-pipe-test", syscall_pipe_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-sigprocmask-test", syscall_sigprocmask_test,
    ...
    KTEST_UNIT("syscall-sigpending-test", syscall_sigpending_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-sigaction-test", syscall_sigaction_test,
            (KT_KERNEL_BUF(0xBFFFFF00), KT_USER_BUF(NULL)),
            (KT_KERNEL_BUF(0xBFFFFF00), KT_USER_BUF(0xBFFFFFFF)),
            (KT_KERNEL_BUF(0xBFFFFF00), KT_USER_BUF(0xC0200000)),
            (KT_USER_BUF(NULL),       KT_KERNEL_BUF(0xBFFFFF00)),
    ...
    KTEST_UNIT("syscall-sigwait-test", syscall_sigwait_test,
            (KT_KERNEL_BUF(0xBFFFFF00), KT_USER_BUF(NULL)),
            (KT_KERNEL_BUF(0xBFFFFF00), KT_USER_BUF(0xBFFFFFFF)),
            (KT_KERNEL_BUF(0xBFFFFF00), KT_USER_BUF(0xC0200000)),
            (KT_USER_BUF(NULL),       KT_KERNEL_BUF(0xBFFFFF00)),
    ...
    KTEST_UNIT("syscall-sigsuspend-test", syscall_sigsuspend_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-time-test", syscall_time_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-getpgrp-test", syscall_getpgrp_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-poll-test", syscall_poll_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-sendto-test", syscall_sendto_test,
            (KT_KERNEL_BUF(0xBFFFFF00), KT_USER_BUF(NULL)),
            (KT_KERNEL_BUF(0xBFFFFF00), KT_USER_BUF(0xBFFFFFFF)),
            (KT_KERNEL_BUF(0xBFFFFF00), KT_USER_BUF(0xC0200000)),
            (KT_USER_BUF(NULL),       KT_KERNEL_BUF(0xBFFFFF00)),
    ...
    KTEST_UNIT("syscall-bind-test", syscall_bind_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-getsockname-test", syscall_getsockname_test,
            (KT_KERNEL_BUF(0xBFFFFF00), KT_USER_BUF(NULL)),
            (KT_KERNEL_BUF(0xBFFFFF00), KT_USER_BUF(0xBFFFFFFF)),
            (KT_KERNEL_BUF(0xBFFFFF00), KT_USER_BUF(0xC0200000)),
            (KT_USER_BUF(NULL),       KT_KERNEL_BUF(0xBFFFFF00)),
    ...
    KTEST_UNIT("syscall-send-test", syscall_send_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-gettimeofday-test", syscall_gettimeofday_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-setgroups-test", syscall_setgroups_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-getgroups-test", syscall_getgroups_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-uname-test", syscall_uname_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),

    KTEST_UNIT("syscall-connect-test", syscall_connect_test,
            (KT_USER_BUF(NULL)),
            (KT_USER_BUF(0xBFFFFFFE)),
            (KT_USER_BUF(0xC0200000))),
